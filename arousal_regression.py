# -*- coding: utf-8 -*-
"""
Created on Fri Aug 5 21:23:56 2022
@author: harisushehu
"""
...
VAL_DIR = "./data/val"
RESULTS_FILE = "./results/regressionArousal_DT.csv"
SELECTED_FEATURES_FILE = "./results/regressionArousal_selected_features.csv"
FEATURES_THRESHOLD_FILE = "./results/regressionArousal_features.csv"
MODEL_SAVE_PATH = "./models"
initial_model_path = os.path.join(MODEL_SAVE_PATH, "regressionArousal_DT_initial.pkl")
selected_model_path = os.path.join(MODEL_SAVE_PATH, "regressionArousal_DT_selected_features.pkl")

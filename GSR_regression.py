# -*- coding: utf-8 -*-
"""
Created on Fri Aug 5 19:14:03 2022
@author: harisushehu
"""
...
VAL_DIR = "./data/val"
RESULTS_FILE = "./results/regressionGSR_DT.csv"
SELECTED_FEATURES_FILE = "./results/regressionGSR_selected_features.csv"
FEATURES_THRESHOLD_FILE = "./results/regressionGSR_features.csv"
MODEL_SAVE_PATH = "./models"
initial_model_path = os.path.join(MODEL_SAVE_PATH, "regressionGSR_DT_initial.pkl")
selected_model_path = os.path.join(MODEL_SAVE_PATH, "regressionGSR_DT_selected_features.pkl")
...
X_train = train_data.drop(columns=['GSR_mean'])
y_train = train_data['GSR_mean'].values

X_val = val_data.drop(columns=['GSR_mean'])
y_val = val_data['GSR_mean'].values
